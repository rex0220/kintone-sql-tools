...
export function createServer(args: ServerArgs): McpServer {
  ...
  server.registerTool("ksql_run_saved_query", {
    ...
    description: "Run a saved kSQL query. Read-only queries and batches, including WITH CTE-body GENERATE_SERIES integer/DATE series, use ksql_query safety and support DECLARE variable injection; DML queries require ksql_mutate safety inputs.",
