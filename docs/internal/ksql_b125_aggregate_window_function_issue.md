...
- 起票: 2026-08-05
- ステータス: 📝 **評価（方向判断待ち）**。**ウィンドウ機構は既にあり、拡張は素直**（`applyWindow` の
  パーティション分割・ソート・**同順検出**がそのまま使える）。**最大の論点はフレーム既定値と同順の扱い**で、
  ここを誤ると「静かに間違う」帯域に入る。実需は確認済み（在庫の累積推移）
...
|---|---:|---:|---:|
| 2026-03-18 | +100 | 130 | 130 |
| 2026-03-18 | −30 | **130** | 100 |
| 2026-03-18 | −20 | **130** | 80 |
