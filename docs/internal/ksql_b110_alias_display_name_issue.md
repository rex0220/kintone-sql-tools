...
- 起票: 2026-08-02
- ステータス: ✅ **完了（v3.38.0 でリリース）**（2026-08-02・受入 §4.4 の 7 ケースを dist-engine の公開 API で実測確認。codex の停止 1 回＝既存テスト 3 件の機械的更新の確認）。**Pro も同日に取り込み・実機確認・出荷完了**（[報告 2026-08-02b](../../../ksql-dashboard-pro/docs/internal/kSQLエンジンへの連絡-20260802b-送付版.md)＝クロス集計の実例・グラフ凡例・既存設定の無変更動作すべて OK・移行作業ゼロ）
