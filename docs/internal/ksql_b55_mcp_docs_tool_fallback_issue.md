...
- 起票日: 2026-07-21
- ステータス: ✅ **v3.12.0 リリース済み（2026-07-21・PR #198・tag/GitHub Release 公開・npm publish 待ち・実機 PASS＝[evidence](evidence/b55_claude_desktop_smoke.md)）**（[仕様 R2.1](ksql_b55_mcp_docs_tool_spec.md) / [計画 R1](ksql_b55_impl_plan.md)）
