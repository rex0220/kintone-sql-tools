...
- 箇所: `src/core/generateSeries.ts:33`、`src/core/generateSeries.ts:86`
...
- テスト不足: `src/__tests__/b149GenerateSeries.test.ts:213` は通常の小数だけで、浮動小数点丸め・underflow 境界を検査していない。
...
- 箇所: `src/core/generateSeries.ts:112`、`src/__tests__/b149GenerateSeries.test.ts:218`
