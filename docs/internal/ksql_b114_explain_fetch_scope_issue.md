...
- 起票: 2026-08-04
- ステータス: ✅ **完了（v3.40.0 第 1 段＋第 2 段／v3.41.0 で NONE→COUNT_ONLY）**（2026-08-04）。**Pro も同日に取り込み・実装完了**（[報告 2026-08-04b](../../../ksql-dashboard-pro/docs/internal/kSQLエンジンへの連絡-20260804b-送付版.md)＝形の変更 2 点とも妥当と回答・K-109 の注意書きは不要になり削除・純加法とバンドル無影響を実機確認）＝仕様は §4（第 1 段）・§5（第 2 段）
