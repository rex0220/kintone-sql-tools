...
- 起票: 2026-07-29
- ステータス: ✅ **案 A＝リリース済み（v3.32.0・2026-07-29）／案 B＝[B97](ksql_b97_incomplete_aggregate_failclosed_issue.md) へ独立起票（Pro が要望）**。→ [実装仕様](ksql_b95_truncation_visibility_spec.md)
