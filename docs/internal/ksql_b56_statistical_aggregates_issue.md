...
- 起票日: 2026-07-22
- ステータス: ✅ **v3.13.0 リリース済み（2026-07-22・release PR #210・tag/GitHub Release 公開・npm publish 待ち）。実装済み・CLI 実機 PASS・リリース待ち（2026-07-22・[仕様 R2.1](ksql_b56_statistical_aggregates_spec.md)・[実機証跡](evidence/b56_statistical_aggregates_smoke.md)）**。起票時 codex レビュー（P1×1/P2×5/P3×1）反映済
- 種別: 改善（集計関数の拡充）
