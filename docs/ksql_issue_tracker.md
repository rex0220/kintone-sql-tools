...
- 次回リリース計画: **未定**。**B119・B120（いずれも正しさ・優先 高・エラーを出さずに誤った結果を返す）が未着手**（2026-08-04 起票）。他は優先 低 か実需待ち（§1）。クローズ済みは §3。
