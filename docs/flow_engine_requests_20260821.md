...
- ステータス: 🚧 **B170＝E-6/E-3/E-5/E-1 を v3.70.0 でリリース（publish/実機確認待ち）・E-4 文書回答済み・E-2 設計提案 R1 往復中**（2026-08-21。codex 依頼書レビューで事実前提 4 件を訂正＝E-3 の型・E-5 の差分前提・E-1 のキー昇順・E-2 の pre-read 流用。回答=`ksql-flow/docs/kSQLエンジンからの申し送り-20260821-v3700.md`）。台帳: [ksql_issue_tracker.md](ksql_issue_tracker.md)
